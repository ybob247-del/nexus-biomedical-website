 ...
 * Modal for collecting user information for coming soon platforms
 */

import React, { useState } from 'react';

export default function WaitlistModal({ platform, onClose }) {
          ...
          <>
            ...
            <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
              ...
              <h2 style={{
                ...
                Join the {platform.name} Waitlist
              </h2>
              ...
              <p style={{
                ...
                Be the first to know when {platform.name} launches. We'll send you an email with early access details.
              </p>
            </div>
