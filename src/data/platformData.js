export const platformsData = {
  ...
  'EndoGuard™': {
    ...
    pricing: [
      ...
      { tier: 'Premium Plus', price: '$49', period: 'per month', features: ['All Premium features', 'Expert lab interpretation (4/year)', 'Advanced AI predictive modeling', 'Priority support (12-hour response)', 'Quarterly check-in calls', 'Supplement recommendations', '14-day free trial'], stripeKey: 'endoguard_premium_plus' },
      { tier: 'Provider Basic', price: '$99', period: 'per month', features: ['Clinical decision support', 'Patient management (up to 50)', 'Research database access', 'CEU credits (12/year)', 'Patient education handouts', 'Lab interpretation tools', 'HIPAA-compliant messaging'], stripeKey: 'endoguard_provider_basic' },
