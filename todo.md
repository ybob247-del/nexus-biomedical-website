...
## 🚨 CRITICAL: Free Trial Flow Implementation (Nov 21, 2025)
### Database Schema
- [x] Add trial_start_date, trial_end_date, trial_status to users table
- [x] Add subscription_status field (trial/active/expired/cancelled)
- [x] Add platform_access field (rxguard/endoguard/both)
- [x] Create platforms table with correct trial durations
- [x] Create platform_trials table for tracking
- [x] Create subscriptions table for paid access
- [x] Create usage_tracking table
- [x] Create email_notifications table

### Signup Flow
- [ ] Update "Start Free Trial" buttons to navigate to /signup
- [ ] Modify signup to automatically grant trial access
- [ ] Set trial_start_date and calculate trial_end_date on signup
- [ ] Send welcome email after signup

### Trial Tracking
- [ ] Implement trial expiration checking middleware
- [ ] Show "X days left in trial" banner in platforms
- [ ] Block platform access when trial expires

### Email Notifications (Percentage-based)
- [ ] Day 1: Welcome email with trial details
- [ ] 50% mark: "Halfway through your trial" email
- [ ] 25% mark: "Only X days left" email
- [ ] 1 day before: "Trial expires tomorrow" email
- [ ] Expiration day: "Trial ended - subscribe to continue" email

### Payment Gate
- [ ] Create PaymentGate component for expired trials
- [ ] Show payment options when trial expires
- [ ] Link to Stripe checkout with correct pricing
