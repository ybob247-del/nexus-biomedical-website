export const platformsData = {
  ...
  'EndoGuard™': {
    ...
    pricing: [
      ...
      { tier: 'Premium Plus', price: '$49', period: 'per month', features: ['All Premium features', 'Advanced AI predictive modeling', 'Supplement recommendations', 'Priority support', 'Monthly progress tracking', '14-day free trial'], stripeKey: 'endoguard_premium_plus' },
